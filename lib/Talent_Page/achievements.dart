...
class _AcheivementsState extends State<Acheivements> {
  ...
  void loadPageData() async {
    ...
    setState(() {
      acheivement1Controller.text = prefs.getString('one') ?? '';
      acheivement2Controller.text = prefs.getString('two') ?? '';
      acheivement3Controller.text = prefs.getString('three') ?? '';
      acheivement4Controller.text = prefs.getString('four') ?? '';
      acheivement5Controller.text = prefs.getString('five') ?? '';
                                      ...
                                      child: ElevatedButton(
                                        ...
                                        onPressed: () async {
                                          if (_formkey.currentState!.validate()) {
                                            SharedPreferences prefs = await SharedPreferences.getInstance();
                                            await prefs.setString('one', acheivement1Controller.text);
                                            await prefs.setString('two', acheivement2Controller.text);
                                            await prefs.setString('three', acheivement3Controller.text);
                                            await prefs.setString('four', acheivement4Controller.text);
                                            await prefs.setString('five', acheivement5Controller.text);
    ...
    return TextFormField(
      ...
      validator: (value) {
        ...
        if (value!.isEmpty &&
          ...
          return 'Enter atleast one achievement';
        }
        return null;
      },
    );
